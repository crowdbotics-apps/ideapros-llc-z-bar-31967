...
## Project Structure
    ...
    ├── ideapros_llc_z_bar_31967  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_z_bar_31967`
...
2. Clone this repo and `cd ideapros_llc_z_bar_31967`
